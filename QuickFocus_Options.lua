...
local TEXT = ns.isChinese and {
    ...
    RAID_MARKER = "团队标记",
    TRIGGER_KEY = "触发按键",
    CLEAR_ON_BLANK = "无单位处使用相同按键时，清除焦点及其标记（额外占用 1 个宏槽）",
    ...
    CLEAR_ON_BLANK = "Clear focus and its marker with the same key over empty space (uses 1 additional macro slot)",
